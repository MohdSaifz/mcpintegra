 ...
 */
export function formatSchemaAsMarkdown(schema, systemName) {
 ...
 */
function formatSchemaObjectMarkdown(schema, indent) {
 ...
 */
export function formatSchemaAsJSON(schema) {
    return JSON.stringify(schema, null, 2);
}
/**
 * Format mapping as markdown
 */
export function formatMappingsAsMarkdown(suggestions) {
 ...
 */
export function formatMappingAsJSON(mapping) {
